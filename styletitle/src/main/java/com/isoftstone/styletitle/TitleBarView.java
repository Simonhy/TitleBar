package com.isoftstone.styletitle;
...
/**
 * 自定义标题栏,可以进行其扩展
 * Created by yonghuangl on 2017/5/27.
 */
public class TitleBarView extends LinearLayout {
     ...
     * 距离左边的距离
     */
    private int left_button_margin;
    /**
     * 距离右边的距离
     */
    private int right_button_margin;

    public void setLeft_button_margin(int left_button_margin) {
        this.left_button_margin = left_button_margin;
    }

    public void setRight_button_margin(int right_button_margin) {
        this.right_button_margin = right_button_margin;
    }

    public TitleBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        /**加载布局文件*/
        LayoutInflater.from(context).inflate(R.layout.coustom_title_bar, this, true);
        ...
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.CustomTitleBar_left_button_image, R.drawable.im_back);
        ...
        left_button_margin = typedArray.getLayoutDimension(R.styleable.CustomTitleBar_left_button_margin, 0);
        right_button_margin = typedArray.getLayoutDimension(R.styleable.CustomTitleBar_right_button_margin, 0);

        /**设置值*/
        setLeft_button_margin(left_button_margin);
        setRight_button_margin(right_button_margin);
